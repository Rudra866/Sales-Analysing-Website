import {z} from "zod";
import {role_options_config} from "@/components/dialogs/CreateRoleDialog";
...
export const passwordField = z.string().nonempty({message: "Password must not be empty."})
const passwordModifyField = passwordField
    .min(8, {message: "Password must be at least 8 characters."})

const generalStringField = z.string()
        .nonempty({
          message: "Required"})
        .max(255, {

...
} from "@/components/dialogs/forgot-password-dialog";
      ...
      <>
        ...
        <FormModal {...args} {...modalControls}>
          <ForgotPasswordDialog
            ...
            error={error}
            setError={
              setError as unknown as Dispatch<SetStateAction<string | null>>
            }
            setSuccess={
              setSuccess as unknown as Dispatch<SetStateAction<boolean>>
            }
          />
        </FormModal>
      </>

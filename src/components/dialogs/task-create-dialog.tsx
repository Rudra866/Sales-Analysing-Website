    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
        <DialogBody className={"space-y-2 w-full"}>
          ...
          <div
            className={
              "flex flex-row align-middle justify-between items-center w-full gap-2"
            }
          >
            <Popover>
            ...
            <PopoverTrigger asChild>
              ...
              >
                {employeeValue
                  ? employees.find(
                      (employee) =>
                        employee.Name.toLowerCase() === employeeValue,
                    )?.Name
                  : "Select Employee"}
                    ...
                    {employees.map((employee) => (
                      <CommandItem
                        ...
                        onSelect={(currentValue) => {
                          setEmployeeValue(
                            currentValue === employeeValue ? "" : currentValue,
                          );
                      ...
                      >
                        ...
                        <CheckIcon
                          className={cn(
                            "ml-auto h-4 w-4",
                            employeeValue === employee.Name.toLowerCase()
                              ? "opacity-100"
                              : "opacity-0",
                          )}
                        />

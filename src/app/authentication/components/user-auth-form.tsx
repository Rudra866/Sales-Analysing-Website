...
export default function UserAuthForm({
  ...
  const resetUserPassword = async (
    data: z.infer<typeof forgotPasswordDialogSchema>,
  ) => {
    ...
    <div className="lg:p-8">
      <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
        ...
        <div className={cn("grid gap-6", className)} {...props}>
            ...
            <div className="grid gap-2">
              <div className="grid gap-1">
                ...
                {validationErrors.email && (
                  <div className="text-red-600">{validationErrors.email}</div>
                )}
              ...
              <Button disabled={isLoading}>
                ...
                {error && <Icons.warning className="text-red-500" />}
          ...
          <FormModal
            showDialog={passwordDialogOpen}
            setShowDialog={setPasswordDialogOpen}

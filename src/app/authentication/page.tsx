...
export default function AuthenticationPage() {
    ...
    return (
        <section className="container py-10">
            <div className="container relative hidden h-[800px] flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0 rounded-[1rem] overflow-hidden border">
